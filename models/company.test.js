...
describe("findAll - COMPANIES", function () {
  ...
  test("works: name filter only", async function () {
  ...
  test("works: minEmployees filter only", async function () {
  ...
  test("works: maxEmployees filter only", async function () {
  ...
  test("returns empty array if no companies match filters", async function () {
    const results = await Company.findAll({ name: "test" });
